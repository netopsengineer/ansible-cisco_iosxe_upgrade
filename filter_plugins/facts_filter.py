...
class FilterModule(object):
    def filters(self):
        return {
            ...
            'iosxe_find_required_binary': iosxe_find_required_binary,
            'iosxe_install_cmd_usage': iosxe_install_cmd_usage,
            'iosxe_parse_dir_output': iosxe_parse_dir_output,
            'iosxe_parse_inactive': iosxe_parse_inactive,
